  ...
  <div class="container">
    ...
    <div class="col-md-12 ">
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="keranjang" role="tabpanel" aria-labelledby="tab-keranjang">
          <table class="table table-striped">
                ...
                <tr>
                  ...
                  <form action="" method="POST">
                    ...
                    <td>
                      ...
                      <!-- <button name="ubahCart" class="btn btn-sm btn-primary"><i class="icon icon-edit"></i></button> -->
                    </td>
                  </form>
            ...
            <tfoot>
              ...
              <tr>
                ...
                <td><a class="btn btn-sm btn-success" href="<?= url ?>user/cekOut22.php">Checkout</a></td>
              </tr>
            </tfoot>
          </table>
        </div>
